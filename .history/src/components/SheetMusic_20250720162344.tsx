...
const SheetMusic: React.FC<SheetMusicProps> = ({ midiData, onNoteClick, fileName }) => {
 ...
 // Rest of the component remains the same but with enhanced error handling...
 // [Include all remaining methods from the original SheetMusic.tsx with the same logic]
 ...
 // Include all other methods (renderPage, navigation, cleanup, etc.) from the original file
 // ... [Same as original implementation but with enhanced error handling and tuplet support]
